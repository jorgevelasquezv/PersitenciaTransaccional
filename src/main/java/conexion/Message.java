...
public class Message implements Serializable {
    ...
    /**
     * Constructor don dos parámetros usado para construir un objeto message cuando se desea enviar una directiva de
    ...
    /**
     * Agrega un cliente destino a la lista de clientes destinos habilitada en el servidor
     * @param destiny identificador de cliente a agregar en la lista de destinos
     */
    ...
    /**
     * Establece el destinatario al que se le enviara el mensaje
     * @param destiny nombre del destinatario del mensaje
     */
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(type, message1.type) && Objects.equals(destiny, message1.destiny) && Objects.equals(sender, message1.sender) && Objects.equals(message, message1.message) && Objects.equals(destinies, message1.destinies);
    }
